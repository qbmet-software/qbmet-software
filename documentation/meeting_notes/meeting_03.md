...
| Role | Member(s) | Focus Area(s) | Core Deliverables |
| :--- | :--- | :--- | :--- |
| **Control System Engineer** | **Francesca** (Primary), **Ian** (Support) | Primary Motor Control Loop (PID), Tuning. | Design, implementation, and tuning of the primary `motor_control` logic for torque/angle precision. |
